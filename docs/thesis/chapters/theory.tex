...
A Zha rendszer három különböző generatív modellt kombinál, amelyek együttműködése a zenei kreativitás különböző aspektusait fedi le. A Markov-lánc alapú komponens zeneelméleti tudással kiegészített sztochasztikus megközelítést alkalmaz, amely megragadja a rövid távú mintázatokat és harmóniai összefüggéseket. A Variational Autoencoder architektúra a latens tér-alapú reprezentációk révén kreatív variációk generálására képes, miközben megtartja a zenei koherenciát. A Transformer modell felelős a hosszú távú szerkezeti tudatosság és globális koherencia biztosításáért, amely különösen fontos a komplex zenei formák előállításánál.

A kombinált generálási folyamat során a rendszer először hangnem és skála elemzést végez a bemeneti MIDI anyagból. Ezt követően az akkordprogresszió generálás Markov modell segítségével történik, amely figyelembe veszi a harmóniai szabályokat és mintázatokat. Az alapvető dallam előállítása szintén a Markov komponens feladata, amely akkord-tudatos megközelítést alkalmaz. A VAE modell ezután kreatív variációkat hoz létre, amelyeket skála-alapú szűréssel finomítanak. Végül a Transformer biztosítja a szerkezeti koherenciát, és a rendszer súlyozott kombinálást hajt végre a különböző modellek kimenetein, megőrizve a zenei skála integritását.

\subsection{Adatfeldolgozási pipeline}
A MIDI fájlok feldolgozása során a rendszer robusztus parsing mechanizmust alkalmaz, amely az egyes hangszerek hangjegyeit elemzi és feldolgozza. A hangmagasság információk súlyozottan kerülnek rögzítésre, ahol a sebesség értékek normalizált formában reprezentálják a dinamikai viszonyokat. Ez a megközelítés 128-dimenziós hangmagasság hisztogrammá konvertálja a MIDI adatokat, amely tömör, ugyanakkor informatív reprezentációt biztosít a harmonikus tartalomról.

A zeneelméleti integráció során a rendszer hangnem felismerési, skála generálási és akkord elemzési funkciókat alkalmaz. A római számjelölés kezelése lehetővé teszi a harmonikus progressziók formális reprezentációját és elemzését, amely alapvető fontosságú a zeneileg koherens kimenet előállításához.
