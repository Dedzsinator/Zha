...
\usepackage[utf8]{inputenc} % UTF-8 encoding for Hungarian characters
\usepackage{fix-cm} % Allow arbitrary font sizes for Computer Modern
\usepackage{amsmath, amssymb, graphicx, subcaption}
% hyperref is loaded in definitions.sty with proper options
\usepackage{amsthm}
\usepackage{listings}
